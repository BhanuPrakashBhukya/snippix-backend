...
* The original package name 'com.meloffy.snippix.auth-service' is invalid and this project uses 'com.meloffy.snippix.auth_service' instead.
...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/3.5.9-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.server)
